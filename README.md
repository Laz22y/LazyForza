...
- 默认关闭的 Preview 阶段漂移仪表盘，用本车 UDP 遥测推导侧滑角、稳定度、连续稳定时长与练习建议；可独立显示或与主仪表盘并排显示，并支持独立拖动和固定中心缩放；
...
漂移仪表盘首次开启时会说明其推导边界，并可选择开启“自动关闭主仪表盘”。漂移仪表盘开启期间，圈速分析停止订阅且不会写入新的圈速；关闭后按用户原有偏好恢复主仪表盘与圈速分析。
