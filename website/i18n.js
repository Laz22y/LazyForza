(function initializeWebsiteLocalization(globalObject) {
  ...
  const ENGLISH = {
    ...
    "按距离对齐速度、驾驶输入和走线，选择真实参考圈，比较手动标记的弯道区间。": "Align speed, driving inputs and racing lines by distance, choose a recorded reference lap and compare manually marked corners.",
