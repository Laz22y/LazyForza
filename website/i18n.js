(function initializeWebsiteLocalization(globalObject) {
  ...
  const ENGLISH = {
    "预览版 1.5.3-alpha-2": "Preview 1.5.3-alpha-2",
    "预览版 1.5.3-alpha-2：优化原创无线电提示音与播报停顿，支持自定义接通/断开音和随机试听，修复启动检查更新时侧栏变白的问题。推荐搭配 RaceServer 0.6.0-alpha-1；协议保持 v2，预览版使用独立更新通道。": "Preview 1.5.3-alpha-2 refines original radio cues and speech pauses, adds custom connect/disconnect sounds and random previews, and fixes the white sidebar during startup update checks. RaceServer 0.6.0-alpha-1 is recommended. Protocol v2 is retained and previews use a separate update channel.",
